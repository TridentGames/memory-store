...
/**
 * The reference managed is internal to a store and should not be exposed outside the class. It is responsible for storing, managing and creating references to objects held with a store.
 *
...
public interface ReferenceManager<T> {
    ...
    /**
     * Create a new reference for the given object. If a reference already exists for this item, return existing reference without adding duplicate.
     *
