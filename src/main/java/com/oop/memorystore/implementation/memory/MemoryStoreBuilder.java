...
public final class MemoryStoreBuilder<V> {
    ...
    public MemoryStoreBuilder<V> withValue(final V value) {
        this.store.add(value);
        return this;
    }

    public MemoryStoreBuilder<V> withValues(final Collection<V> values) {
    ...
    public <K> MemoryStoreBuilder<V> withIndex(
