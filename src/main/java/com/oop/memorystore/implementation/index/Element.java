...
/**
 * A wrapper around an element in the data store. Only call {@link #get()} when necessary, depending on the Store implementation this may result in an IO operation.
 *
 * @param <V> value type
 */
